...
5. `cd neovide`
6. Make sure `cargo-bundle` is installed by executing `cargo install cargo-bundle`
7. `cargo bundle --release`
8. Copy `./target/release/bundle/osx/Neovide.app` to a known location and enjoy.
