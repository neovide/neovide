...
By default, the IME preedit event—that is, the preview of the text being composed—is not implemented. You can implement this preview yourself by using preedit_handler().
