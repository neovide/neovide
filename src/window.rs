...
use skulpin::{CoordinateSystem, PresentMode, Renderer as SkulpinRenderer};
use skulpin::{RendererBuilder, Sdl2Window};
...
impl WindowWrapper {
    pub fn new() -> WindowWrapper {
        ...
        let previous_size = logical_size;
    ...
    pub fn draw_frame(&mut self) -> bool {
        ...
        if REDRAW_SCHEDULER.should_draw() || SETTINGS.get::<WindowSettings>().no_idle {
            ...
            if self
                .skulpin_renderer
                .draw(&sdl_window, |canvas, coordinate_system_helper| {
