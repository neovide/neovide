...
use super::{
    ...
    UserEvent, WindowCommand, WindowSettings, WindowSettingsChanged, WindowSize,
};
...
impl WinitWindowWrapper {
    ...
    pub fn handle_window_command(&mut self, target: EventTarget, command: WindowCommand) {
        ...
        match command {
            ...
            WindowCommand::HighlightMatchingPair {
                ...
                if let (Some(rect), Some(macos_feature)) = (rect, &route.window.macos_feature) {
                    macos_feature
                        .borrow_mut()
    ...
    pub fn handle_window_event(&mut self, window_id: WindowId, event: WindowEvent) -> bool {
        ...
        // Message selection via mouse drag is a client overlay rendered by neovide.
        let overlay_event = {
