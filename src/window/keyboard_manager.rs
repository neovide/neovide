    ...
    fn handle_numpad_key(key_event: &KeyEvent) -> Option<&str> {
        ...
        match key_event.physical_key {
            ...
            KeyCode::Numpad8 => KeyboardManager::handle_numpad_numkey(
                is_numlock_key, "<k8>", "<kUp>"),
            KeyCode::Numpad7 => KeyboardManager::handle_numpad_numkey(
                is_numlock_key, "<k7>", "<kHome>"),
            KeyCode::Numpad6 => KeyboardManager::handle_numpad_numkey(
                is_numlock_key, "<k6>", "<kRight>"),
            KeyCode::Numpad5 => KeyboardManager::handle_numpad_numkey(
                is_numlock_key, "<k5>", "<kOrigin>"),
            KeyCode::Numpad4 => KeyboardManager::handle_numpad_numkey(
                is_numlock_key, "<k4>", "<kLeft>"),
            KeyCode::Numpad3 => KeyboardManager::handle_numpad_numkey(
                is_numlock_key, "<k3>", "<kPageDown>"),
            KeyCode::Numpad2 => KeyboardManager::handle_numpad_numkey(
                is_numlock_key, "<k2>", "<kDown>"),
            KeyCode::Numpad1 => KeyboardManager::handle_numpad_numkey(
                is_numlock_key, "<k1>", "<kEnd>"),
            KeyCode::Numpad0 => KeyboardManager::handle_numpad_numkey(
                is_numlock_key, "<k0>", "<Insert>"),
            _ => None
        }
    }
